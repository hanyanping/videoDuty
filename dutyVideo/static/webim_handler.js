...
//隐藏评论文本框
    function hideDiscussForm() {
        //$(".dutyVideo-discuss-form").hide();
    }

//显示评论文本框
    function showDiscussForm() {
        //$(".dutyVideo-discuss-form").show();
    }

//隐藏评论工具栏
    function hideDiscussTool() {
        //$(".dutyVideo-discuss-tool").hide();
    }

//显示评论工具栏
    function showDiscussTool() {
        //$(".dutyVideo-discuss-tool").show();
    }

//隐藏表情框
    function hideDiscussEmotion() {
        //$(".dutyVideo-discuss-emotion").hide();
        ////$(".dutyVideo-discuss-emotion").fadeOut("slow");
    }

//显示表情框
    function showDiscussEmotion() {
        //$(".dutyVideo-discuss-emotion").show();
        //$(".dutyVideo-discuss-emotion").fadeIn("slow");
...
//展示点赞动画
    function showLoveMsgAnimation() {
        ...
        // var toolDiv = document.getElementById("dutyVideo-discuss-tool");
