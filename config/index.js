...
module.exports = {
  ...
  build: {
    ...
    assetsSubDirectory: 'dutyVideo/static/',
    assetsPublicPath: '/',
    ...
    // Gzip off by default as many popular dutyVideo hosts such as
    // Surge or Netlify already gzip all dutyVideo images for you.
